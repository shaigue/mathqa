...
class Program:
    ...
    def from_linear_formula(cls, linear_formula: str):
        ...
        # for each split, create it's arguments and op_list
        for op_index, op_and_args in enumerate(linear_formula_split):
            ...
            for arg_index, arg in enumerate(args):
                ...
                # add all the edges between the arguments and the op_list
    ...
    def sub_program(self, node_subset: frozenset[OperationNode], return_original_to_input_map=False):
        ...
        """
        assert self._is_operations_only(node_subset), "not only op_list"
    ...
    def __hash__(self):
        """Hashing by the number of op_list in each type"""
